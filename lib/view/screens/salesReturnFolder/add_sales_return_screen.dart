...
class AddSalesReturnScreen extends StatefulWidget {
  static String addSalesReturnScreenRoute = "/AddSalesReturnScreen";

  const AddSalesReturnScreen({Key? key}) : super(key: key);
              ...
              Padding(
                ...
                child: Row(
                  children: [
                    Expanded(
                      child: TextWidget(
                        text: "Edit Sale Return Date & Number",
                        textStyle: _commonClass.getTextStyle(
                ...
                children: [
                  Container(
                    ...
                    child: InkWell(
                      ...
                      child: ListTile(
                        title: TextWidget(
                            text: "Sales Return Date (8 march 2022)",
                            textStyle: _commonClass.getTextStyle(
                                12,
                                _colorClass.secondaryBrandColor,
                                CommonClass.medium)),
