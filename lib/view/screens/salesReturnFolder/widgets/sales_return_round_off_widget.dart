...
class SalesReturnRoundOffWidget extends StatefulWidget {
  const SalesReturnRoundOffWidget({Key? key}) : super(key: key);

  @override
  State<SalesReturnRoundOffWidget> createState() => _SalesReturnRoundOffWidgetState();
}
final CommonClass _commonClass=CommonClass();
final ColorClass _colorClass=ColorClass();
final StringFile _stringFile=StringFile();
class _SalesReturnRoundOffWidgetState extends State<SalesReturnRoundOffWidget> {
