...
class SalesReturnDiscountWidget extends StatefulWidget {
  const SalesReturnDiscountWidget({Key? key}) : super(key: key);

  @override
  State<SalesReturnDiscountWidget> createState() => _SalesReturnDiscountWidgetState();
}
final CommonClass _commonClass=CommonClass();
final ColorClass _colorClass=ColorClass();
final StringFile _stringFile=StringFile();
class _SalesReturnDiscountWidgetState extends State<SalesReturnDiscountWidget> {
