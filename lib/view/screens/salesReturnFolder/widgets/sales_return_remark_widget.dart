...
class SalesReturnRemarkWidget extends StatefulWidget {
  const SalesReturnRemarkWidget({Key? key}) : super(key: key);

  @override
  State<SalesReturnRemarkWidget> createState() => _SalesReturnRemarkWidgetState();
}
final CommonClass _commonClass=CommonClass();
final ColorClass _colorClass=ColorClass();
final StringFile _stringFile=StringFile();
class _SalesReturnRemarkWidgetState extends State<SalesReturnRemarkWidget> {
