...
class SalesReturnNotesWidget extends StatefulWidget {
  const SalesReturnNotesWidget({Key? key}) : super(key: key);

  @override
  State<SalesReturnNotesWidget> createState() => _SalesReturnNotesWidgetState();
}
final CommonClass _commonClass=CommonClass();
final ColorClass _colorClass=ColorClass();
final StringFile _stringFile=StringFile();
class _SalesReturnNotesWidgetState extends State<SalesReturnNotesWidget> {
