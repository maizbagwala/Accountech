...
class SalesReturnPartyAdd extends StatefulWidget {
  const SalesReturnPartyAdd({Key? key}) : super(key: key);

  @override
  State<SalesReturnPartyAdd> createState() => _SalesReturnPartyAddState();
}
String _searchParty = "";
final CommonClass _commonClass=CommonClass();
final ColorClass _colorClass=ColorClass();
final StringFile _stringFile=StringFile();
class _SalesReturnPartyAddState extends State<SalesReturnPartyAdd> {
  @override
        ...
        dropdownDecoratorProps:DropDownDecoratorProps(dropdownSearchDecoration: InputDecoration(
            ...
            focusedBorder: OutlineInputBorder(
                borderSide: BorderSide(
                    ...
                    _colorClass.secondaryBrandColor,
                    width: 1)),
            labelText: "Search Sales Manager",
          )),
          selectedItem: "Data 1"),
      const SizedBox(
        height: 20,
