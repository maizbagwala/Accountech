...
class SalesReturnItemsWidget extends StatefulWidget {
  const SalesReturnItemsWidget({Key? key}) : super(key: key);

  @override
  State<SalesReturnItemsWidget> createState() => _SalesReturnItemsWidgetState();
}
...
class _SalesReturnItemsWidgetState extends State<SalesReturnItemsWidget> {
