...
class PurchaseScreen extends StatefulWidget {
  static String purchaseScreenRoute = "/PurchaseScreen";
      ...
      appBar: PreferredSize(
        ...
        child: Column(
          children: [
            CommonAppBarWidget(
              title: TextWidget(
                text: _stringFile.purchaseReturn,
                          ...
                          builder: (context) =>
                              StatefulBuilder(
                                  builder: (context, bottomSheetSetState) {
                                    return const AddPurchaseReturnScreen();
                                  }),
                        ).whenComplete(() {
                ...
                itemBuilder: (context, index) {
                  return PurchaseListItem(
                    ...
                    item: Data(
                        ...
                        goodsInTransitNo:
                        controller.purchaseReturnList[index].purchaseReturnNo,
                        dueIn: controller.purchaseReturnList[index].dueIn,
                        amount: controller.purchaseReturnList[index].amount),
                    onDelete: () {
                      controller.deletePurchaseReturn(controller
                          .purchaseReturnList[index].id.toString()).then((value) {
                        if(value!=""){
                          controller.getPurchaseReturnList();
                        }
                      });
