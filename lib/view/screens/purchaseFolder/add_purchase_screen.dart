...
import 'package:accountech/view/screens/purchaseFolder/widgets/purchase_body_widget.dart';
...
class AddPurchaseScreen extends StatefulWidget {
  static String addPurchaseScreenRoute = "/AddPurchaseScreen";
    ...
    return SafeArea(
      child: Scaffold(
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  CommonAppBarWidget(
                    title: TextWidget(
                      text: _stringFile.createPurchase,
        ...
        body: ExpandableTheme(
          ...
          child: const PurchaseBodyWidget(),
        ),
              ...
              Padding(
                ...
                child: Row(
                  children: [
                    Expanded(
                      child: TextWidget(
                        text: _stringFile.editPurchaseDateAndNumber,
                        textStyle: _commonClass.getTextStyle(
                ...
                children: [
                  Container(
                    ...
                    child: InkWell(
                      ...
                      child: ListTile(
                        title: TextWidget(
                            text: "${_stringFile.purchaseDate} (8 march 2022)",
                            textStyle: _commonClass.getTextStyle(
                                12,
                                _colorClass.secondaryBrandColor,
                                CommonClass.medium)),
                  ...
                  TextFieldWidget(
                      ...
                      text: _stringFile.purchaseNumber,
                  ...
                  TextFieldWidget(
                      ...
                      text: _stringFile.originalInvoiceNumber,
                      onTypeCallBack: (e) {}),
                  ExpandableNotifier(
