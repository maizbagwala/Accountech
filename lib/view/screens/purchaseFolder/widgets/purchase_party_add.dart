...
class PurchaseOrderPartyAdd extends StatefulWidget {
  const PurchaseOrderPartyAdd({Key? key}) : super(key: key);

  @override
  State<PurchaseOrderPartyAdd> createState() => _PurchaseOrderPartyAddState();
}
String _searchParty = "";
final CommonClass _commonClass=CommonClass();
final ColorClass _colorClass=ColorClass();
final StringFile _stringFile=StringFile();
class _PurchaseOrderPartyAddState extends State<PurchaseOrderPartyAdd> {
  @override
