...
class PurchaseAdditionalChargesWidget extends StatefulWidget {
  const PurchaseAdditionalChargesWidget({Key? key}) : super(key: key);

  @override
  State<PurchaseAdditionalChargesWidget> createState() => _PurchaseAdditionalChargesWidgetState();
}
...
class _PurchaseAdditionalChargesWidgetState extends State<PurchaseAdditionalChargesWidget> {
  @override
