...
class PurchaseOrderItemsWidget extends StatefulWidget {
  const PurchaseOrderItemsWidget({Key? key}) : super(key: key);

  @override
  State<PurchaseOrderItemsWidget> createState() => _PurchaseOrderItemsWidgetState();
}
...
class _PurchaseOrderItemsWidgetState extends State<PurchaseOrderItemsWidget> {
