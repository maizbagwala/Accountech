...
class PurchaseOrderRemarkWidget extends StatefulWidget {
  const PurchaseOrderRemarkWidget({Key? key}) : super(key: key);

  @override
  State<PurchaseOrderRemarkWidget> createState() => _PurchaseOrderRemarkWidgetState();
}
final CommonClass _commonClass=CommonClass();
final ColorClass _colorClass=ColorClass();
final StringFile _stringFile=StringFile();
class _PurchaseOrderRemarkWidgetState extends State<PurchaseOrderRemarkWidget> {
