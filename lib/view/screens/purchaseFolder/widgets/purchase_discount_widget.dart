...
class PurchaseOrderDiscountWidget extends StatefulWidget {
  const PurchaseOrderDiscountWidget({Key? key}) : super(key: key);

  @override
  State<PurchaseOrderDiscountWidget> createState() => _PurchaseOrderDiscountWidgetState();
}
final CommonClass _commonClass=CommonClass();
final ColorClass _colorClass=ColorClass();
final StringFile _stringFile=StringFile();
class _PurchaseOrderDiscountWidgetState extends State<PurchaseOrderDiscountWidget> {
