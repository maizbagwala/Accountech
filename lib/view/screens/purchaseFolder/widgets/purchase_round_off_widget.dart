...
class PurchaseOrderRoundOffWidget extends StatefulWidget {
  const PurchaseOrderRoundOffWidget({Key? key}) : super(key: key);

  @override
  State<PurchaseOrderRoundOffWidget> createState() => _PurchaseOrderRoundOffWidgetState();
}
final CommonClass _commonClass=CommonClass();
final ColorClass _colorClass=ColorClass();
final StringFile _stringFile=StringFile();
class _PurchaseOrderRoundOffWidgetState extends State<PurchaseOrderRoundOffWidget> {
