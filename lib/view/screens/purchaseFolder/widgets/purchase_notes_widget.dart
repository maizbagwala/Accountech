...
class PurchaseOrderNotesWidget extends StatefulWidget {
  const PurchaseOrderNotesWidget({Key? key}) : super(key: key);

  @override
  State<PurchaseOrderNotesWidget> createState() => _PurchaseOrderNotesWidgetState();
}
final CommonClass _commonClass=CommonClass();
final ColorClass _colorClass=ColorClass();
final StringFile _stringFile=StringFile();
class _PurchaseOrderNotesWidgetState extends State<PurchaseOrderNotesWidget> {
