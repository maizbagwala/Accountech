...
class GoodsInTransitRemarkWidget extends StatefulWidget {
  const GoodsInTransitRemarkWidget({Key? key}) : super(key: key);

  @override
  State<GoodsInTransitRemarkWidget> createState() => _GoodsInTransitRemarkWidgetState();
}
final CommonClass _commonClass=CommonClass();
final ColorClass _colorClass=ColorClass();
final StringFile _stringFile=StringFile();
class _GoodsInTransitRemarkWidgetState extends State<GoodsInTransitRemarkWidget> {
