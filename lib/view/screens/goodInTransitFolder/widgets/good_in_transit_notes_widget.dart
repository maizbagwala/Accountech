...
class GoodsInTransitNotesWidget extends StatefulWidget {
  final Function getNote;
  const GoodsInTransitNotesWidget({Key? key, required this.getNote}) : super(key: key);

  @override
  State<GoodsInTransitNotesWidget> createState() => _GoodsInTransitNotesWidgetState();
}
final CommonClass _commonClass=CommonClass();
final ColorClass _colorClass=ColorClass();
final StringFile _stringFile=StringFile();
class _GoodsInTransitNotesWidgetState extends State<GoodsInTransitNotesWidget> {
