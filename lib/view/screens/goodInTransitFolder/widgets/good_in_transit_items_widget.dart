...
class GoodsInTransitItemsWidget extends StatefulWidget {
  const GoodsInTransitItemsWidget({Key? key}) : super(key: key);

  @override
  State<GoodsInTransitItemsWidget> createState() => _GoodsInTransitItemsWidgetState();
}
...
class _GoodsInTransitItemsWidgetState extends State<GoodsInTransitItemsWidget> {
  var _itemList=<Data>[];
  ...
  void initState() {
    super.initState();
    itemController.getItems().then((value) {
      if(value != ""){
        setState(() {
          _itemList=value as List<Data>;
        });
      }
    });
  }
                                      ...
                                      children: [
                                        Column(
                                          ...
                                          children: [
                                            ...
                                            TextWidget(
                                                text: _itemList[index].stockQty.toString()??"",
                                                textStyle:
                                                    _commonClass.getTextStyle(
                                                        12,
                                                        _colorClass.blackColor,
                                        ...
                                        Column(
                                          ...
                                          children: [
                                            ...
                                            TextWidget(
                                                text: "₹ ${_itemList[index].salesPrice}"??"₹ ",
                                                textStyle:
                                                    _commonClass.getTextStyle(
                                                        12,
                                                        _colorClass.blackColor,
