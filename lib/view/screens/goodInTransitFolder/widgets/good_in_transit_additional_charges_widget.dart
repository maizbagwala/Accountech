...
class GoodsInTransitAdditionalChargesWidget extends StatefulWidget {
  const GoodsInTransitAdditionalChargesWidget({Key? key}) : super(key: key);

  @override
  State<GoodsInTransitAdditionalChargesWidget> createState() => _GoodsInTransitAdditionalChargesWidgetState();
}
...
class _GoodsInTransitAdditionalChargesWidgetState extends State<GoodsInTransitAdditionalChargesWidget> {
  @override
