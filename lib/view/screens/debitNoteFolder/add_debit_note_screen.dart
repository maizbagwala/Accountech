...
class AddDebitNoteScreen extends StatefulWidget {
  static String addDebitNoteScreenRoute = "/AddDebitNoteScreen";

  const AddDebitNoteScreen({Key? key}) : super(key: key);

  @override
  State<AddDebitNoteScreen> createState() => _AddDebitNoteScreenState();
}
...
class _AddDebitNoteScreenState extends State<AddDebitNoteScreen> {
  @override
  void initState() {
    super.initState();
  }
              ...
              Padding(
                ...
                child: Row(
                  children: [
                    Expanded(
                      child: TextWidget(
                        text: "Edit Debit Note Date & Number",
                        textStyle: _commonClass.getTextStyle(
                ...
                children: [
                  Container(
                    ...
                    child: InkWell(
                      ...
                      child: ListTile(
                        title: TextWidget(
                            text: "Debit Note Date (8 march 2022)",
                            textStyle: _commonClass.getTextStyle(
                                12,
                                _colorClass.secondaryBrandColor,
                                CommonClass.medium)),
                  ...
                  Container(
                    ...
                    child: InkWell(
                      ...
                      child: ListTile(
                        title: TextWidget(
                            text: "Validity Date (8 march 2022)",
                            textStyle: _commonClass.getTextStyle(
                                12,
                                _colorClass.secondaryBrandColor,
                                CommonClass.medium)),
