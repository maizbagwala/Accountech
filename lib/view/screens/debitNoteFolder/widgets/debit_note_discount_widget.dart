...
class DebitNoteDiscountWidget extends StatefulWidget {
  const DebitNoteDiscountWidget({Key? key}) : super(key: key);

  @override
  State<DebitNoteDiscountWidget> createState() => _DebitNoteDiscountWidgetState();
}
final CommonClass _commonClass=CommonClass();
final ColorClass _colorClass=ColorClass();
final StringFile _stringFile=StringFile();
class _DebitNoteDiscountWidgetState extends State<DebitNoteDiscountWidget> {
