...
class DebitNoteNotesWidget extends StatefulWidget {
  const DebitNoteNotesWidget({Key? key}) : super(key: key);

  @override
  State<DebitNoteNotesWidget> createState() => _DebitNoteNotesWidgetState();
}
final CommonClass _commonClass=CommonClass();
final ColorClass _colorClass=ColorClass();
final StringFile _stringFile=StringFile();
class _DebitNoteNotesWidgetState extends State<DebitNoteNotesWidget> {
