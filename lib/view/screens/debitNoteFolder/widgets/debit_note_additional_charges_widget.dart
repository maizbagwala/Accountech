...
class DebitNoteAdditionalChargesWidget extends StatefulWidget {
  const DebitNoteAdditionalChargesWidget({Key? key}) : super(key: key);

  @override
  State<DebitNoteAdditionalChargesWidget> createState() => _DebitNoteAdditionalChargesWidgetState();
}
...
class _DebitNoteAdditionalChargesWidgetState extends State<DebitNoteAdditionalChargesWidget> {
  @override
