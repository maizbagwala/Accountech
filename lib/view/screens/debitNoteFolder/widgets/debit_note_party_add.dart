...
class DebitNotePartyAdd extends StatefulWidget {
  const DebitNotePartyAdd({Key? key}) : super(key: key);

  @override
  State<DebitNotePartyAdd> createState() => _DebitNotePartyAddState();
}
String _searchParty = "";
final CommonClass _commonClass=CommonClass();
final ColorClass _colorClass=ColorClass();
final StringFile _stringFile=StringFile();
class _DebitNotePartyAddState extends State<DebitNotePartyAdd> {
  @override
