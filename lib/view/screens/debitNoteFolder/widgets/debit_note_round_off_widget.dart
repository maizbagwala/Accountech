...
class DebitNoteRoundOffWidget extends StatefulWidget {
  const DebitNoteRoundOffWidget({Key? key}) : super(key: key);

  @override
  State<DebitNoteRoundOffWidget> createState() => _DebitNoteRoundOffWidgetState();
}
final CommonClass _commonClass=CommonClass();
final ColorClass _colorClass=ColorClass();
final StringFile _stringFile=StringFile();
class _DebitNoteRoundOffWidgetState extends State<DebitNoteRoundOffWidget> {
