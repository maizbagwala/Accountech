...
class DebitNoteItemsWidget extends StatefulWidget {
  const DebitNoteItemsWidget({Key? key}) : super(key: key);

  @override
  State<DebitNoteItemsWidget> createState() => _DebitNoteItemsWidgetState();
}
...
class _DebitNoteItemsWidgetState extends State<DebitNoteItemsWidget> {
