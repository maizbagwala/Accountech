...
class DebitNoteRemarkWidget extends StatefulWidget {
  const DebitNoteRemarkWidget({Key? key}) : super(key: key);

  @override
  State<DebitNoteRemarkWidget> createState() => _DebitNoteRemarkWidgetState();
}
final CommonClass _commonClass=CommonClass();
final ColorClass _colorClass=ColorClass();
final StringFile _stringFile=StringFile();
class _DebitNoteRemarkWidgetState extends State<DebitNoteRemarkWidget> {
