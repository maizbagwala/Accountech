...
class PurchaseReturnRoundOffWidget extends StatefulWidget {
  const PurchaseReturnRoundOffWidget({Key? key}) : super(key: key);

  @override
  State<PurchaseReturnRoundOffWidget> createState() => _PurchaseReturnRoundOffWidgetState();
}
final CommonClass _commonClass=CommonClass();
final ColorClass _colorClass=ColorClass();
final StringFile _stringFile=StringFile();
class _PurchaseReturnRoundOffWidgetState extends State<PurchaseReturnRoundOffWidget> {
