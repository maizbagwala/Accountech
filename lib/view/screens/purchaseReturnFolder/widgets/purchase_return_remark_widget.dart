...
class PurchaseReturnRemarkWidget extends StatefulWidget {
  const PurchaseReturnRemarkWidget({Key? key}) : super(key: key);

  @override
  State<PurchaseReturnRemarkWidget> createState() => _PurchaseReturnRemarkWidgetState();
}
final CommonClass _commonClass=CommonClass();
final ColorClass _colorClass=ColorClass();
final StringFile _stringFile=StringFile();
class _PurchaseReturnRemarkWidgetState extends State<PurchaseReturnRemarkWidget> {
