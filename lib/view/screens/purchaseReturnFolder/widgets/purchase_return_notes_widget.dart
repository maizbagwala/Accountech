...
class PurchaseReturnNotesWidget extends StatefulWidget {
  const PurchaseReturnNotesWidget({Key? key}) : super(key: key);

  @override
  State<PurchaseReturnNotesWidget> createState() => _PurchaseReturnNotesWidgetState();
}
final CommonClass _commonClass=CommonClass();
final ColorClass _colorClass=ColorClass();
final StringFile _stringFile=StringFile();
class _PurchaseReturnNotesWidgetState extends State<PurchaseReturnNotesWidget> {
