...
class PurchaseReturnPartyAdd extends StatefulWidget {
  const PurchaseReturnPartyAdd({Key? key}) : super(key: key);

  @override
  State<PurchaseReturnPartyAdd> createState() => _PurchaseReturnPartyAddState();
}
String _searchParty = "";
final CommonClass _commonClass=CommonClass();
final ColorClass _colorClass=ColorClass();
final StringFile _stringFile=StringFile();
class _PurchaseReturnPartyAddState extends State<PurchaseReturnPartyAdd> {
  @override
