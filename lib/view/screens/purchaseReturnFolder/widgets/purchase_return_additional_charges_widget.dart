...
class PurchaseReturnAdditionalChargesWidget extends StatefulWidget {
  const PurchaseReturnAdditionalChargesWidget({Key? key}) : super(key: key);

  @override
  State<PurchaseReturnAdditionalChargesWidget> createState() => _PurchaseReturnAdditionalChargesWidgetState();
}
...
class _PurchaseReturnAdditionalChargesWidgetState extends State<PurchaseReturnAdditionalChargesWidget> {
  @override
