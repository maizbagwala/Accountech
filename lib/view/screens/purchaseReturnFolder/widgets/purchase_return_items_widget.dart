...
class PurchaseReturnItemsWidget extends StatefulWidget {
  const PurchaseReturnItemsWidget({Key? key}) : super(key: key);

  @override
  State<PurchaseReturnItemsWidget> createState() => _PurchaseReturnItemsWidgetState();
}
...
class _PurchaseReturnItemsWidgetState extends State<PurchaseReturnItemsWidget> {
