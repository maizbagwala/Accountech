...
class PurchaseReturnDiscountWidget extends StatefulWidget {
  const PurchaseReturnDiscountWidget({Key? key}) : super(key: key);

  @override
  State<PurchaseReturnDiscountWidget> createState() => _PurchaseReturnDiscountWidgetState();
}
final CommonClass _commonClass=CommonClass();
final ColorClass _colorClass=ColorClass();
final StringFile _stringFile=StringFile();
class _PurchaseReturnDiscountWidgetState extends State<PurchaseReturnDiscountWidget> {
