...
import 'package:accountech/view/screens/purchaseOrderFolder/widgets/purchase_order_body_widget.dart';
...
class AddPurchaseOrderScreen extends StatefulWidget {
  static String addPurchaseOrderScreenRoute = "/AddPurchaseOrderScreen";
    ...
    return SafeArea(
      child: Scaffold(
        appBar: PreferredSize(
            preferredSize:
            const Size.fromHeight(CommonClass.headerHeight + 136),
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  CommonAppBarWidget(
                    title: TextWidget(
                      text: _stringFile.createPurchaseOrder,
                    ...
                    child: Column(
                      ...
                      children: [
                          ...
                          child: InkWell(
                            ...
                            child: Padding(
                              ...
                              child: Row(
                                ...
                                children: [
                                  TextWidget(
                                      text: "${_stringFile.purchaseOrder} #1",
                                      textStyle: _commonClass.getTextStyle(
                                          15,
                        ...
                        Row(
                          ...
                          children: [
                            TextWidget(
                                text: "${_stringFile.originalInvoice} #-",
                                textStyle: _commonClass.getTextStyle(
                                    15,
        ...
        body: ExpandableTheme(
          ...
          child: const PurchaseOrderBodyWidget(),
        ),
              ...
              Padding(
                ...
                child: Row(
                  children: [
                    Expanded(
                      child: TextWidget(
                        text: _stringFile.editPurchaseOrderDateAndNumber,
                        textStyle: _commonClass.getTextStyle(
                ...
                children: [
                  Container(
                    ...
                    child: InkWell(
                      ...
                      child: ListTile(
                        title: TextWidget(
                            text: "${_stringFile.purchaseOrderDate} (8 march 2022)",
                            textStyle: _commonClass.getTextStyle(
                                12,
                                _colorClass.secondaryBrandColor,
                                CommonClass.medium)),
                  ...
                  TextFieldWidget(
                      ...
                      text: _stringFile.purchaseOrderNumber,
                      onTypeCallBack: (e) {}),
                  ExpandableNotifier(
