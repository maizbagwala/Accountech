...
class PurchaseOrderAdditionalChargesWidget extends StatefulWidget {
  const PurchaseOrderAdditionalChargesWidget({Key? key}) : super(key: key);

  @override
  State<PurchaseOrderAdditionalChargesWidget> createState() => _PurchaseOrderAdditionalChargesWidgetState();
}
...
class _PurchaseOrderAdditionalChargesWidgetState extends State<PurchaseOrderAdditionalChargesWidget> {
  @override
