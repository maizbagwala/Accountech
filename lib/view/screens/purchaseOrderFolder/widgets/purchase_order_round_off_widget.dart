...
class PurchaseRoundOffWidget extends StatefulWidget {
  const PurchaseRoundOffWidget({Key? key}) : super(key: key);

  @override
  State<PurchaseRoundOffWidget> createState() => _PurchaseRoundOffWidgetState();
}
final CommonClass _commonClass=CommonClass();
final ColorClass _colorClass=ColorClass();
final StringFile _stringFile=StringFile();
class _PurchaseRoundOffWidgetState extends State<PurchaseRoundOffWidget> {
