...
class PurchaseRemarkWidget extends StatefulWidget {
  const PurchaseRemarkWidget({Key? key}) : super(key: key);

  @override
  State<PurchaseRemarkWidget> createState() => _PurchaseRemarkWidgetState();
}
final CommonClass _commonClass=CommonClass();
final ColorClass _colorClass=ColorClass();
final StringFile _stringFile=StringFile();
class _PurchaseRemarkWidgetState extends State<PurchaseRemarkWidget> {
