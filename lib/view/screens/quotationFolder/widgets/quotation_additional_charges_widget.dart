...
class QuotationAdditionalChargesWidget extends StatefulWidget {
  const QuotationAdditionalChargesWidget({Key? key}) : super(key: key);

  @override
  State<QuotationAdditionalChargesWidget> createState() => _QuotationAdditionalChargesWidgetState();
}
...
class _QuotationAdditionalChargesWidgetState extends State<QuotationAdditionalChargesWidget> {
  @override
