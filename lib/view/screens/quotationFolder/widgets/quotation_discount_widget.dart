...
class QuotationDiscountWidget extends StatefulWidget {
  const QuotationDiscountWidget({Key? key}) : super(key: key);

  @override
  State<QuotationDiscountWidget> createState() => _QuotationDiscountWidgetState();
}
final CommonClass _commonClass=CommonClass();
final ColorClass _colorClass=ColorClass();
final StringFile _stringFile=StringFile();
class _QuotationDiscountWidgetState extends State<QuotationDiscountWidget> {
