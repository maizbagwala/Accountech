...
class QuotationNotesWidget extends StatefulWidget {
  const QuotationNotesWidget({Key? key}) : super(key: key);

  @override
  State<QuotationNotesWidget> createState() => _QuotationNotesWidgetState();
}
final CommonClass _commonClass=CommonClass();
final ColorClass _colorClass=ColorClass();
final StringFile _stringFile=StringFile();
class _QuotationNotesWidgetState extends State<QuotationNotesWidget> {
