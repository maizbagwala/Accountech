...
class QuotationItemsWidget extends StatefulWidget {
  const QuotationItemsWidget({Key? key}) : super(key: key);

  @override
  State<QuotationItemsWidget> createState() => _QuotationItemsWidgetState();
}
...
class _QuotationItemsWidgetState extends State<QuotationItemsWidget> {
