...
class QuotationRemarkWidget extends StatefulWidget {
  const QuotationRemarkWidget({Key? key}) : super(key: key);

  @override
  State<QuotationRemarkWidget> createState() => _QuotationRemarkWidgetState();
}
final CommonClass _commonClass=CommonClass();
final ColorClass _colorClass=ColorClass();
final StringFile _stringFile=StringFile();
class _QuotationRemarkWidgetState extends State<QuotationRemarkWidget> {
