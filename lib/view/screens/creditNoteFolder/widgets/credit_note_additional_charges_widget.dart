...
class CreditNoteAdditionalChargesWidget extends StatefulWidget {
  const CreditNoteAdditionalChargesWidget({Key? key}) : super(key: key);

  @override
  State<CreditNoteAdditionalChargesWidget> createState() => _CreditNoteAdditionalChargesWidgetState();
}
...
class _CreditNoteAdditionalChargesWidgetState extends State<CreditNoteAdditionalChargesWidget> {
  @override
