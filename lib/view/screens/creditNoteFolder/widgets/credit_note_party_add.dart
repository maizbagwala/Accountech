...
class CreditNotePartyAdd extends StatefulWidget {
  const CreditNotePartyAdd({Key? key}) : super(key: key);

  @override
  State<CreditNotePartyAdd> createState() => _CreditNotePartyAddState();
}
String _searchParty = "";
final CommonClass _commonClass=CommonClass();
final ColorClass _colorClass=ColorClass();
final StringFile _stringFile=StringFile();
class _CreditNotePartyAddState extends State<CreditNotePartyAdd> {
  @override
