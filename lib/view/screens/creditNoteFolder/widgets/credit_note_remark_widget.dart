...
class CreditNoteRemarkWidget extends StatefulWidget {
  const CreditNoteRemarkWidget({Key? key}) : super(key: key);

  @override
  State<CreditNoteRemarkWidget> createState() => _CreditNoteRemarkWidgetState();
}
final CommonClass _commonClass=CommonClass();
final ColorClass _colorClass=ColorClass();
final StringFile _stringFile=StringFile();
class _CreditNoteRemarkWidgetState extends State<CreditNoteRemarkWidget> {
