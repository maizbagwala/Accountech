...
class CreditNoteItemsWidget extends StatefulWidget {
  const CreditNoteItemsWidget({Key? key}) : super(key: key);

  @override
  State<CreditNoteItemsWidget> createState() => _CreditNoteItemsWidgetState();
}
...
class _CreditNoteItemsWidgetState extends State<CreditNoteItemsWidget> {
