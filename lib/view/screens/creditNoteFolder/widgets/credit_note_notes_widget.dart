...
class CreditNoteNotesWidget extends StatefulWidget {
  const CreditNoteNotesWidget({Key? key}) : super(key: key);

  @override
  State<CreditNoteNotesWidget> createState() => _CreditNoteNotesWidgetState();
}
final CommonClass _commonClass=CommonClass();
final ColorClass _colorClass=ColorClass();
final StringFile _stringFile=StringFile();
class _CreditNoteNotesWidgetState extends State<CreditNoteNotesWidget> {
