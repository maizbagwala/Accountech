...
import 'package:accountech/view/screens/invoiceFolder/widgets/invoice_body_widget.dart';
...
class AddInvoiceScreen extends StatefulWidget {
  static String addInvoiceScreenRoute = "/AddInvoiceScreen";
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  CommonAppBarWidget(
                    title: TextWidget(
                      text: _stringFile.createInvoice,
                          ...
                          child: InkWell(
                            ...
                            child: Padding(
                              ...
                              child: Row(
                                ...
                                children: [
                                  TextWidget(
                                      text: "${_stringFile.invoiceDate} #1",
                                      textStyle: _commonClass.getTextStyle(
                                          15,
              ...
              Padding(
                ...
                child: Row(
                  children: [
                    Expanded(
                      child: TextWidget(
                        text: _stringFile.editInvoiceDateAndNumber,
                        textStyle: _commonClass.getTextStyle(
                ...
                children: [
                  Container(
                    ...
                    child: InkWell(
                      ...
                      child: ListTile(
                        title: TextWidget(
                            text: "${_stringFile.invoiceDate} (8 march 2022)",
                            textStyle: _commonClass.getTextStyle(
                                12,
                                _colorClass.secondaryBrandColor,
                                CommonClass.medium)),
                  ...
                  Container(
                    ...
                    child: InkWell(
                      ...
                      child: ListTile(
                        title: TextWidget(
                            text: "${_stringFile.dueDate} (8 march 2022)",
                            textStyle: _commonClass.getTextStyle(
                                12,
                                _colorClass.secondaryBrandColor,
                                CommonClass.medium)),
                  ...
                  TextFieldWidget(
                      ...
                      text: _stringFile.invoiceNumber,
                      onTypeCallBack: (e) {}),
                  ExpandableNotifier(
