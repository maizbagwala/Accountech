...
class InvoiceRoundOffWidget extends StatefulWidget {
  const InvoiceRoundOffWidget({Key? key}) : super(key: key);

  @override
  State<InvoiceRoundOffWidget> createState() => _InvoiceRoundOffWidgetState();
}
final CommonClass _commonClass=CommonClass();
final ColorClass _colorClass=ColorClass();
final StringFile _stringFile=StringFile();
class _InvoiceRoundOffWidgetState extends State<InvoiceRoundOffWidget> {
