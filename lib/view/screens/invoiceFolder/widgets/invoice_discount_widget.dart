...
class InvoiceDiscountWidget extends StatefulWidget {
  const InvoiceDiscountWidget({Key? key}) : super(key: key);

  @override
  State<InvoiceDiscountWidget> createState() => _InvoiceDiscountWidgetState();
}
final CommonClass _commonClass=CommonClass();
final ColorClass _colorClass=ColorClass();
final StringFile _stringFile=StringFile();
class _InvoiceDiscountWidgetState extends State<InvoiceDiscountWidget> {
