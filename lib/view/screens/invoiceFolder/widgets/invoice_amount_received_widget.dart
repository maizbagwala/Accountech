...
class InvoiceAmountReceivedWidget extends StatefulWidget {
  const InvoiceAmountReceivedWidget({Key? key}) : super(key: key);

  @override
  State<InvoiceAmountReceivedWidget> createState() => _InvoiceAmountReceivedWidgetState();
}
final CommonClass _commonClass=CommonClass();
final ColorClass _colorClass=ColorClass();
final StringFile _stringFile=StringFile();
class _InvoiceAmountReceivedWidgetState extends State<InvoiceAmountReceivedWidget> {
