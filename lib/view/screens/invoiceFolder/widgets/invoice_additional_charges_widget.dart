...
class InvoiceAdditionalChargesWidget extends StatefulWidget {
  const InvoiceAdditionalChargesWidget({Key? key}) : super(key: key);

  @override
  State<InvoiceAdditionalChargesWidget> createState() => _InvoiceAdditionalChargesWidgetState();
}
...
class _InvoiceAdditionalChargesWidgetState extends State<InvoiceAdditionalChargesWidget> {
  @override
