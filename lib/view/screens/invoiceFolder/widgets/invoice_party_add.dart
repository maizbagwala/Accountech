...
class InvoicePartyAdd extends StatefulWidget {
  const InvoicePartyAdd({Key? key}) : super(key: key);

  @override
  State<InvoicePartyAdd> createState() => _InvoicePartyAddState();
}
String _searchParty = "";
final CommonClass _commonClass=CommonClass();
final ColorClass _colorClass=ColorClass();
final StringFile _stringFile=StringFile();
class _InvoicePartyAddState extends State<InvoicePartyAdd> {
  @override
