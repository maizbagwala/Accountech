...
class SalesOrderRemarkWidget extends StatefulWidget {
  const SalesOrderRemarkWidget({Key? key}) : super(key: key);

  @override
  State<SalesOrderRemarkWidget> createState() => _SalesOrderRemarkWidgetState();
}
final CommonClass _commonClass=CommonClass();
final ColorClass _colorClass=ColorClass();
final StringFile _stringFile=StringFile();
class _SalesOrderRemarkWidgetState extends State<SalesOrderRemarkWidget> {
