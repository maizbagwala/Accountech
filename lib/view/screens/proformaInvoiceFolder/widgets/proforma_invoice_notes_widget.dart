...
class ProformaInvoiceNotesWidget extends StatefulWidget {
  const ProformaInvoiceNotesWidget({Key? key}) : super(key: key);

  @override
  State<ProformaInvoiceNotesWidget> createState() => _ProformaInvoiceNotesWidgetState();
}
final CommonClass _commonClass=CommonClass();
final ColorClass _colorClass=ColorClass();
final StringFile _stringFile=StringFile();
class _ProformaInvoiceNotesWidgetState extends State<ProformaInvoiceNotesWidget> {
