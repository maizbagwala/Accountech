...
class ProformaInvoiceRemarkWidget extends StatefulWidget {
  const ProformaInvoiceRemarkWidget({Key? key}) : super(key: key);

  @override
  State<ProformaInvoiceRemarkWidget> createState() => _ProformaInvoiceRemarkWidgetState();
}
final CommonClass _commonClass=CommonClass();
final ColorClass _colorClass=ColorClass();
final StringFile _stringFile=StringFile();
class _ProformaInvoiceRemarkWidgetState extends State<ProformaInvoiceRemarkWidget> {
