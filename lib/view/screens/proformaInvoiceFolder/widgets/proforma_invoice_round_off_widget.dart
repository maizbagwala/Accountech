...
class ProformaInvoiceRoundOffWidget extends StatefulWidget {
  const ProformaInvoiceRoundOffWidget({Key? key}) : super(key: key);

  @override
  State<ProformaInvoiceRoundOffWidget> createState() => _ProformaInvoiceRoundOffWidgetState();
}
final CommonClass _commonClass=CommonClass();
final ColorClass _colorClass=ColorClass();
final StringFile _stringFile=StringFile();
class _ProformaInvoiceRoundOffWidgetState extends State<ProformaInvoiceRoundOffWidget> {
