...
class ProformaInvoiceItemsWidget extends StatefulWidget {
  const ProformaInvoiceItemsWidget({Key? key}) : super(key: key);

  @override
  State<ProformaInvoiceItemsWidget> createState() => _ProformaInvoiceItemsWidgetState();
}
...
class _ProformaInvoiceItemsWidgetState extends State<ProformaInvoiceItemsWidget> {
