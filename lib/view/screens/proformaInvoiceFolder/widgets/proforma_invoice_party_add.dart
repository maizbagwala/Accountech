...
class ProformaInvoicePartyAdd extends StatefulWidget {
  const ProformaInvoicePartyAdd({Key? key}) : super(key: key);

  @override
  State<ProformaInvoicePartyAdd> createState() => _ProformaInvoicePartyAddState();
}
String _searchParty = "";
final CommonClass _commonClass=CommonClass();
final ColorClass _colorClass=ColorClass();
final StringFile _stringFile=StringFile();
class _ProformaInvoicePartyAddState extends State<ProformaInvoicePartyAdd> {
  @override
