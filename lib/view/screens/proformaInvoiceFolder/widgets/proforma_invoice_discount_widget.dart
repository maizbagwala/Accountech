...
class ProformaInvoiceDiscountWidget extends StatefulWidget {
  const ProformaInvoiceDiscountWidget({Key? key}) : super(key: key);

  @override
  State<ProformaInvoiceDiscountWidget> createState() => _ProformaInvoiceDiscountWidgetState();
}
final CommonClass _commonClass=CommonClass();
final ColorClass _colorClass=ColorClass();
final StringFile _stringFile=StringFile();
class _ProformaInvoiceDiscountWidgetState extends State<ProformaInvoiceDiscountWidget> {
