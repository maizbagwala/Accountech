...
import 'package:accountech/view/screens/proformaInvoiceFolder/widgets/proforma_invoice_body_widget.dart';
...
class AddProformaInvoiceScreen extends StatefulWidget {
  static String addProformaInvoiceScreenRoute = "/AddProformaInvoiceScreen";

  const AddProformaInvoiceScreen({Key? key}) : super(key: key);

  @override
  State<AddProformaInvoiceScreen> createState() => _AddProformaInvoiceScreenState();
}
    ...
    return SafeArea(
      child: Scaffold(
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  CommonAppBarWidget(
                    title: TextWidget(
                      text: "Create New Proforma Invoice",
        ...
        body: ExpandableTheme(
          ...
          child: const ProformaInvoiceBodyWidget(),
        ),
              ...
              Padding(
                ...
                child: Row(
                  children: [
                    Expanded(
                      child: TextWidget(
                        text: "Edit Proforma Invoice Date & Number",
                        textStyle: _commonClass.getTextStyle(
                ...
                children: [
                  Container(
                    ...
                    child: InkWell(
                      ...
                      child: ListTile(
                        title: TextWidget(
                            text: "Invoice Date (8 march 2022)",
                            textStyle: _commonClass.getTextStyle(
                                12,
                                _colorClass.secondaryBrandColor,
                                CommonClass.medium)),
