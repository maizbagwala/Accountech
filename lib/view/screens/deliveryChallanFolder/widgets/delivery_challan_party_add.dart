...
class DeliveryChallanPartyAdd extends StatefulWidget {
  const DeliveryChallanPartyAdd({Key? key}) : super(key: key);

  @override
  State<DeliveryChallanPartyAdd> createState() => _DeliveryChallanPartyAddState();
}
String _searchParty = "";
final CommonClass _commonClass=CommonClass();
final ColorClass _colorClass=ColorClass();
final StringFile _stringFile=StringFile();
class _DeliveryChallanPartyAddState extends State<DeliveryChallanPartyAdd> {
  @override
