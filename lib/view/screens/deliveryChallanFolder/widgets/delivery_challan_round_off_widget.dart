...
class DeliveryChallanRoundOffWidget extends StatefulWidget {
  const DeliveryChallanRoundOffWidget({Key? key}) : super(key: key);

  @override
  State<DeliveryChallanRoundOffWidget> createState() => _DeliveryChallanRoundOffWidgetState();
}
final CommonClass _commonClass=CommonClass();
final ColorClass _colorClass=ColorClass();
final StringFile _stringFile=StringFile();
class _DeliveryChallanRoundOffWidgetState extends State<DeliveryChallanRoundOffWidget> {
