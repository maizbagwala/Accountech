...
class DeliveryChallanDiscountWidget extends StatefulWidget {
  const DeliveryChallanDiscountWidget({Key? key}) : super(key: key);

  @override
  State<DeliveryChallanDiscountWidget> createState() => _DeliveryChallanDiscountWidgetState();
}
final CommonClass _commonClass=CommonClass();
final ColorClass _colorClass=ColorClass();
final StringFile _stringFile=StringFile();
class _DeliveryChallanDiscountWidgetState extends State<DeliveryChallanDiscountWidget> {
