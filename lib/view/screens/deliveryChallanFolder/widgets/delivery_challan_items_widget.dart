...
class DeliveryChallanItemsWidget extends StatefulWidget {
  const DeliveryChallanItemsWidget({Key? key}) : super(key: key);

  @override
  State<DeliveryChallanItemsWidget> createState() => _DeliveryChallanItemsWidgetState();
}
...
class _DeliveryChallanItemsWidgetState extends State<DeliveryChallanItemsWidget> {
