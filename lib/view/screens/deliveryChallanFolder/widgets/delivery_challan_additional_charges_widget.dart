...
class DeliveryChallanAdditionalChargesWidget extends StatefulWidget {
  const DeliveryChallanAdditionalChargesWidget({Key? key}) : super(key: key);

  @override
  State<DeliveryChallanAdditionalChargesWidget> createState() => _DeliveryChallanAdditionalChargesWidgetState();
}
...
class _DeliveryChallanAdditionalChargesWidgetState extends State<DeliveryChallanAdditionalChargesWidget> {
  @override
