...
class DeliveryChallanRemarkWidget extends StatefulWidget {
  const DeliveryChallanRemarkWidget({Key? key}) : super(key: key);

  @override
  State<DeliveryChallanRemarkWidget> createState() => _DeliveryChallanRemarkWidgetState();
}
final CommonClass _commonClass=CommonClass();
final ColorClass _colorClass=ColorClass();
final StringFile _stringFile=StringFile();
class _DeliveryChallanRemarkWidgetState extends State<DeliveryChallanRemarkWidget> {
