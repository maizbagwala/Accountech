...
import 'package:accountech/view/screens/deliveryChallanFolder/widgets/delivery_challan_body_widget.dart';
...
class AddDeliveryChallanScreen extends StatefulWidget {
  static String addDeliveryChallanScreenRoute = "/AddDeliveryChallanScreen";

  const AddDeliveryChallanScreen({Key? key}) : super(key: key);
    ...
    return SafeArea(
      child: Scaffold(
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  CommonAppBarWidget(
                    title: TextWidget(
                      text: _stringFile.createDeliveryChallan,
                          ...
                          child: InkWell(
                            ...
                            child: Padding(
                              ...
                              child: Row(
                                ...
                                children: [
                                  TextWidget(
                                      text: "${_stringFile.deliveryChallan} #1",
                                      textStyle: _commonClass.getTextStyle(
                                          15,
        ...
        body: ExpandableTheme(
          ...
          child: const DeliveryChallanBodyWidget(),
        ),
              ...
              Padding(
                ...
                child: Row(
                  children: [
                    Expanded(
                      child: TextWidget(
                        text: _stringFile.editDeliveryChallanDateAndNumber,
                        textStyle: _commonClass.getTextStyle(
                ...
                children: [
                  Container(
                    ...
                    child: InkWell(
                      ...
                      child: ListTile(
                        title: TextWidget(
                            text: "${_stringFile.deliveryChallanDate} (8 march 2022)",
                            textStyle: _commonClass.getTextStyle(
                                12,
                                _colorClass.secondaryBrandColor,
                                CommonClass.medium)),
                  ...
                  TextFieldWidget(
                      ...
                      text: _stringFile.deliveryChallanNumber,
                      onTypeCallBack: (e) {}),
                  ExpandableNotifier(
