...
import 'package:accountech/model/salesReturnModel/sales_return_list_model.dart';
...
class SalesReturnController extends GetxController {
  ...
  Future<dynamic> getSalesReturnList() async {
    Uri uri = Uri.parse(endpoint.getSalesReturn +
        MySharedPreferences.businessSelectedID.$.toString());
    var response = await http.get(uri);
    try {
      var model = SalesReturnListModel.fromJson(json.decode(response.body));
      salesReturnList.value = model.data!;
      return model;
    } catch (e) {
      return "";
    }
  ...
  Future<dynamic> deleteSaleReturn(String id) async {
    debugPrint("id is ${endpoint.getSalesReturn}$id");
