...
import 'package:accountech/model/debitNote/debit_note_list_model.dart';
...
class DebitNoteController extends GetxController {
  ...
  Future<dynamic> getDebitNoteList() async {
    Uri uri = Uri.parse(endpoint.getDebitNote +
        MySharedPreferences.businessSelectedID.$.toString());
    var response = await http.get(uri);
    try {
      var model = DebitNoteListModel.fromJson(json.decode(response.body));
      debitNoteList.value = model.data!;
      return model;
    } catch (e) {
      return "";
    }
  ...
  Future<dynamic> deleteDebitNote(String id) async {
