...
import '../../model/purchaseOrderModel/purchase_order_list_model.dart';


class PurchaseOrderController extends GetxController {
  var endpoint = ApiServices();
  var purchaseOrderList = <Data>[].obs;
  ...
  Future<dynamic> getPurchaseOrderList() async {
    Uri uri = Uri.parse(endpoint.getPurchaseOrder +
        MySharedPreferences.businessSelectedID.$.toString());
    var response = await http.get(uri);
    try {
      var model = PurchaseOrderListModel.fromJson(json.decode(response.body));
      purchaseOrderList.value = model.data!;
      return model;
    } catch (e) {
      return "";
    }
  ...
  Future<dynamic> deletePurchaseOrder(String id) async {
    debugPrint("id is ${endpoint.getPurchaseOrder}$id");
    Uri uri = Uri.parse(endpoint.getPurchaseOrder + id.toString());
